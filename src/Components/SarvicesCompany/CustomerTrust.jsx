      ...
      <div className='overflow-hidden'>
        <marquee className=" " behavior="scroll" direction="left">
          <div className="flex gap-24 mt-2">
            <img className="mr-8 w-50 h-20" src={image1} alt="" />
            <img className="mr-8 w-50 h-20" src={image2} alt="" />
            <img className="mr-8 w-50 h-20 " src={image3} alt="" />
            <img className="mr-8 w-50 h-20" src={image4} alt="" />
            <img className="mr-8 w-50 h-20" src={image5} alt="" />
            <img className="mr-8 w-50 h-20" src={image6} alt="" />
            <img className="mr-8 w-50 h-20" src={image7} alt="" />
            <img className="mr-8 w-50 h-20" src={image8} alt="" />
            <img className="mr-8 w-50 h-20" src={image9} alt="" />
          </div>
        </marquee>
      </div>
    </div>
